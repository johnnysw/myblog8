		...
		<div id="OSC_Content" class="CenterDiv">
			...
			<div class="MainForm" id="reg_page">
				<form id="frm_reg" action="user/do_reg" method="POST" style="float:left; width:620px;">
					<h2>申请<span style="color: #006600;"> 唯创 Blog</span> 账号，已经申请的请点击<a href="user/login">这里</a>登录</h2>
					...
					<table cellpadding="0" cellspacing="0">
						<tbody>
							...
							<tr>
								<th>姓名：</th>
								<td><input name="username" id="f_name" maxlength="20" class="TEXT" style="width: 150px;" type="text">
							...
							<tr id="tr_gender">
								<th>性别：</th>
								<td>
									<input name="sex" value="男" id="gender_1" type="radio"><label
										for="gender_1">男</label>&nbsp;&nbsp;&nbsp;
									<input name="sex" value="女" id="gender_2" type="radio"><label for="gender_2">女</label>
									<span class="nodisp">请选择性别</span>
								</td>
							</tr>
							<tr id="tr_area">
								<th>居住地区：</th>
								<td><select onchange="showcity(this.value, document.getElementById('userCity'));" name="province"
										id="userProvince">
