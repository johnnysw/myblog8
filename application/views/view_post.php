...
<head>
	...
	<title>测试文章2 - Johnny的博客 - 唯创个人博客</title>
	...
	<div id="OSC_Screen">
		...
		<div id="OSC_Content">
			<div class="SpaceChannel">
				<div id="portrait"><a href="#"><img src="images/portrait.gif" alt="Johnny" title="Johnny" class="SmallPortrait"
							user="154693" align="absmiddle"></a></div>
				<div id="lnks">
					<strong><?php echo $blog->username;?>的博客</strong>
					<div>
						<a href="#">TA的博客列表</a>&nbsp;|
			...
			<div class="Blog">
				...
				<div class="BlogLinks">
					<ul>
						<li>上篇 <span>(54分钟前)</span>：<a href="#" class="prev">测试文章1</a></li>
					</ul>
				</div>
